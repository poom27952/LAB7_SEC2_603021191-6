package com.myweb.lab7dialogrv_sec2_603021191_6
...
class MainActivity : AppCompatActivity() {
    ...
    fun  testStudentData(){
        studentList.add(Student("603021191-6",  "Kiattiphum Suk-amphaichit", 20))
        studentList.add(Student( "603021194-0",  "Junranee",  20))
